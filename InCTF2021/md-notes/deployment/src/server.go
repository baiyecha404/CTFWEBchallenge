...
func debug(w http.ResponseWriter, r *http.Request) {
	...
	// {"Admin_bucket":"b5cd7ae0-7b50-7ae0-7ae0-47a03b473015","VAL_A":245,"VAL_B":143}
...
func main() {
	...
	a, _ := strconv.Atoi("245")
	c, _ := strconv.Atoi("143")

	CONFIG = Config{
		admin_bucket: "b5cd7ae0-7b50-7ae0-7ae0-47a03b473015",
		admin_token:  "flag{test}",
	...
	fmt.Println("App running on http://localhost", 8000)
	handleRequests()
}
