...
exports.SettingsProvider = (props) => {
    const [allowViewers, setAllowViewers] = hooks_1.useLocalStorage("allow-viewers", false);
    const [username, setUsername] = hooks_1.useLocalStorage("username", utils_1.generateUsername());
